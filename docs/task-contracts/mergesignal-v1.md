...
- 2026-08-27 — local release candidate — 28 unit/component tests, 9 end-to-end product journeys, and 9 route-wide accessibility audits pass; lint, TypeScript, production build, and full npm audit are green with zero known vulnerabilities.
